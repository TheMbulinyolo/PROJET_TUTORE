...
- les dependances Python de `requirements.txt`.
...
```bat
python python\main_excel.py data\input.json data\output.json
```
...
3. l'execution de `python\main_excel.py` ;
...
`python\main_excel.py` existe a la racine du projet.
...
```bat
.venv\Scripts\python.exe python\main_excel.py data\input_structure.json data\resultats.json
```
